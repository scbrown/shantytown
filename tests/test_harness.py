...
# The launch string, pinned BYTE FOR BYTE. It moved once, deliberately, when
...
# --- the capability declaration lives on the harness now (aegis-85ox) ------------
...
def test_the_gate_asks_the_CARDS_harness_not_the_runtime(monkeypatch, role, hostable):
    ...
    always builds — but give the card a NON-blocking harness. Before aegis-85ox the
