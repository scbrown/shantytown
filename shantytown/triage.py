...
def _tail(screen: str, n: int = _TAIL_LINES) -> str:
    ...
    #
    # TRAILING BLANK ROWS ARE DROPPED FIRST (aegis-ns56). tmux pads a capture to
    ...
    # (aegis-qxc2); twelve stranded-input panes hid behind seven and printed
    # `idle` (aegis-ns56). awaiting_answer and auth_dead already trimmed for
...
def input_state(screen: str) -> str:
    ...
    TRAILING BLANK ROWS ARE DROPPED FIRST (aegis-ns56), attribute-aware because
