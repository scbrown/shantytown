...
def _cmd_inbox(a) -> int:
    ...
    store. Honoured by the BACKEND SWITCH, not by a hardcoded store: `--backend
    beads --repo <aegis>` gives TrackerInbox (a real bead, surviving cross-session
    and cross-host); the portable files default gives FilesInbox, a lesser-but-real
